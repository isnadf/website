    ...
    <main className="flex min-h-screen flex-col bg-gradient-to-br from-red-50 via-white to-black dark:from-red-950 dark:via-black dark:to-green-950">
      ...
      <section className="relative py-20 md:py-28 flex flex-col items-center text-center bg-gradient-to-r from-red-600/10 via-white/10 to-black/10 dark:from-red-900/20 dark:via-gray-900/20 dark:to-green-800/20 shadow-lg border-b-4 border-red-500">
        <div className="mb-6">
          ...
          <GSAPTextReveal className="text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-red-600 to-black bg-clip-text text-transparent font-sora drop-shadow-lg pt-5 tracking-wider">
            {t("justice.title")}
          </GSAPTextReveal>
          <GSAPTextReveal element="h2" className="text-2xl md:text-3xl font-bold text-red-700 dark:text-red-400 mt-2 h-10">
            {t("justice.subtitle")}
          </GSAPTextReveal>
        ...
        <div className="max-w-2xl mx-auto mt-4">
          ...
          <div className="flex justify-center mt-6 gap-4 flex-wrap">
            <a href="https://forms.gle/your-form-link" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-red-600 to-black text-white font-bold rounded-full shadow-xl hover:from-black hover:to-red-600 transition-all duration-300 text-lg hover:scale-105 hover:shadow-2xl">
              <Scale size={22} className="-ml-1 animate-pulse" /> {t("justice.apply")}
            </a>
            <div className="flex gap-3">
              <a href="/ProgramsFiles/Justice for Palestine Scholarship.docx" download className="inline-flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-full shadow-lg hover:from-blue-600 hover:to-blue-500 transition-all duration-300 text-lg hover:scale-105 hover:shadow-xl">
                <GraduationCap size={20} className="-ml-1" /> {t("justice.download.en")}
              </a>
              <a href="/ProgramsFiles/Justice for Palestine Scholarship AR.docx" download className="inline-flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-full shadow-lg hover:from-blue-600 hover:to-blue-500 transition-all duration-300 text-lg hover:scale-105 hover:shadow-xl">
                <GraduationCap size={20} className="-ml-1" /> {t("justice.download.ar")}
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 md:px-0 bg-gradient-to-r from-red-100/40 via-white to-blue-100/40 dark:from-red-900/30 dark:via-black dark:to-blue-900/30">
        <div className="max-w-7xl mx-auto">
          <GSAPTextReveal element="h2" className="text-3xl md:text-4xl font-bold text-center text-red-700 mb-10">{t("justice.mission.title")}</GSAPTextReveal>
          <div className="max-w-4xl mx-auto text-center mb-8">
            <p className="text-lg text-gray-800 dark:text-gray-100 font-medium mb-4 tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <GSAPReveal animation="scale"><div className="flex flex-col items-center bg-white dark:bg-gray-900 rounded-xl shadow p-6 hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-red-800 dark:text-red-300 mb-2 tracking-wide">{t("justice.fields.international.title")}</h3>
              <p className="text-center text-gray-700 dark:text-gray-200 text-base tracking-wide">{t("justice.fields.international.desc")}</p>
            </div></GSAPReveal>
            <GSAPReveal animation="scale" delay={0.1}><div className="flex flex-col items-center bg-white dark:bg-gray-900 rounded-xl shadow p-6 hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-blue-800 dark:text-blue-300 mb-2 tracking-wide">{t("justice.fields.political.title")}</h3>
              <p className="text-center text-gray-700 dark:text-gray-200 text-base tracking-wide">{t("justice.fields.political.desc")}</p>
            </div></GSAPReveal>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-0 bg-white dark:bg-black">
        <div className="max-w-5xl mx-auto">
          <GSAPTextReveal element="h2" className="text-3xl md:text-4xl font-bold text-center text-red-700 mb-10">{t("justice.fields.title")}</GSAPTextReveal>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <GSAPReveal animation="slide-up"><div className="bg-white dark:bg-gray-900 rounded-xl shadow p-6 flex flex-col items-center min-h-[300px] justify-center hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-red-800 dark:text-red-300 mb-4">{t("justice.fields.political.title")}</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm text-center mb-4">
                {t("justice.fields.political.desc")}
              </p>
              <div className="space-y-2 text-sm">
                {(t("justice.fields.political.points") as unknown as string[]).map((point, index) => (
            ...
            <GSAPReveal animation="slide-up" delay={0.1}><div className="bg-white dark:bg-gray-900 rounded-xl shadow p-6 flex flex-col items-center min-h-[300px] justify-center hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-blue-800 dark:text-blue-300 mb-4">{t("justice.fields.international.title")}</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm text-center mb-4">
                {t("justice.fields.international.desc")}
              </p>
              <div className="space-y-2 text-sm">
                {(t("justice.fields.international.points") as unknown as string[]).map((point, index) => (
                  <div key={index} className="flex items-center gap-2">
      ...
      <section className="py-10 bg-gradient-to-r from-red-100/40 via-white to-blue-100/40 dark:from-red-900/30 dark:via-black dark:to-blue-900/30">
        <div className="max-w-2xl mx-auto text-center">
          <GSAPTextReveal element="h3" className="text-xl font-bold text-red-800 mb-2">{t("justice.contact.title")}</GSAPTextReveal>
          <p className="text-gray-700 dark:text-gray-200 mb-4">{t("justice.contact.desc")}</p>
