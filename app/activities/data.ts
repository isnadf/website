...
export const activitiesData: Activity[] = [
  ...
  },
  {
    ...
    description: {
      ...
      ar: "نظم صندوق دعم الطلاب الفلسطينيين فعالية تواصل في قيرغيزستان، تضمنت وجبة إخاء ومنحاً دراسية مالية. عززت الفعالية روابط المجتمع وشجعت التعاون بين الطلاب الفلسطينيين في الخارج."
    },
    full_description: {
