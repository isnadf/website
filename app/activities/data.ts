...
export const activitiesData: Activity[] = [
  ...
  },
  {
    ...
    title: {
      ...
      ar: "مؤسسة إسناد تلتقي بالطالبات الفلسطينيات في تركيا وتقدم لهن عدداً من المنح"
    },
    date: {
      en: "March 18, 2023",
      ar: "18 مارس 2023"
    ...
    description: {
      ...
      ar: "نظمت مؤسسة إسناد لدعم الطالب الفلسطيني لقاءً تواصليًا مع الطالبات الفلسطينيات في تركيا، للتعرف على احتياجاتهن وتعريفهن برسالتها الداعمة، في إطار تعزيز التواصل وبناء تعاون مستقبلي يخدم مسيرتهن الأكاديمية، كما تم خلال اللقاء تقديم عدد من المنح المالية لجميع الطالبات المشاركات فيه."
    },
    full_description: {
