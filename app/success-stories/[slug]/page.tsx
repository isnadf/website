  ...
  "ahmed-hassan": {
    ...
    story: {
      ...
      ar: [
        ...
        "كل شيء تغير عندما تعلمت عن صندوق الطلاب الفلسطينيين. طلبت منهم برنامج الدكتوراه بأمل بسعادة وتوقعات واقعية. عندما أطلع على أني تم تحديد لمنحة كاملة لمتابعة الدكتوراه في جامعة إسطنبول التقنية، كانت لحياة مغيرة لي ولعائلتي.",
        "جاء الانتقال إلى الحياة في تركيا مع تحدياته – الاختلافات الثقافية، حواجز اللغة، والتكيف مع بيئة أكاديمية جديدة. ومع ذلك، قدم صندوق الطلاب الفلسطينيين أكثر من مجرد دعم مالي. ربطني برنامج الإرشاد الخاص بهم بباحثين فلسطينيين آخرين وأكاديميين أتراك ساعدوني في تخطي هذه التحديات.",
        "ركز بحثي على تطوير خوارزميات التعلم الآلي للبيئات محدودة الموارد، وهو عمل آمل أن يكون له تطبيقات عملية في المناطق ذات البنية التحتية التكنولوجية المحدودة – بما في ذلك فلسطين. خلال دراستي، تمكنت من نشر عدة أوراق في مؤتمرات ومجلات رائدة، وحتى حصلت على تدريب في شركة تقنية رائدة في إسطنبول.",
        "بالإضافة إلى الأكاديميين، أصبح مجتمع صندوق الطلاب الفلسطينيين مثل عائلة ثانية. ساعدت الأحداث الثقافية وفرص التواصل والشعور بالانتماء الذي عززوه في التغلب على الحنين إلى الوطن والبقاء مركزاً على أهدافي.",
        ...
        "لم تكن رحلتي من غزة إلى أن أصبحت حاصلاً على الدكتوراه في علوم الحاسوب ومعلماً ممكنة بدون صندوق الطلاب الفلسطينيين. لم يمولوا تعليمي فحسب؛ بل استثمروا في إمكاناتي ومكنوني من خلق تأثير إيجابي متتالٍ للآخرين من خلفيات مماثلة."
      ]
    },
    achievements: {
      en: [
