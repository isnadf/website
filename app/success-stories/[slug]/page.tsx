  ...
  "ahmed-hassan": {
    ...
    story: {
      en: [
        ...
        "My journey from Gaza to earning a PhD in Computer Science and becoming an educator wouldn't have been possible without the Palestinian Student Fund. They didn't just fund my education – they invested in my potential and enabled me to create a positive ripple effect for others from similar backgrounds."
      ],
      ar: [
  ...
  "omar-khalidi": {
    ...
    story: {
      en: [
        ...
        "During my studies, I focused on sustainable energy solutions, particularly relevant to the energy challenges faced in Palestine. My final year project, in which I developed a low-cost solar water heating system, won recognition at the university's engineering fair.",
        ...
        "My journey from refugee camp to an engineering graduate demonstrates the transformative power of education and the importance of organizations like the Palestinian Student Fund in creating opportunities for young Palestinians."
      ],
      ar: [
  ...
  "rania-abed": {
    ...
    story: {
      en: [
        ...
        "During my studies, I focused on artificial intelligence and machine learning, areas that I believe can have significant impact in Palestine. My final year project, in which I developed an AI-based system for early detection of plant diseases, won recognition at the university's engineering fair.",
  ...
  "leila-hamdan": {
    ...
    story: {
      en: [
        ...
        "During my studies, I specialized in water management and recycling systems, developing solutions that could be implemented in resource-constrained environments. My thesis project, in which I proposed an innovative approach to water purification in Gaza, received recognition from the university's engineering department.",
