...
{                                                                               
    ...
    var tbl = '<table style="border:1px solid">{0}{1}</table>';                 
    ...
    if (parsedJson)                                                               
    {                                                                             
        var isStringArray = typeof(parsedJson[0].PaymentRequest) == 'string';     
        var headers;                                                              
        ...
        {                                                                         
            ...
            if(typeof(parsedJson[0].PaymentRequest) == 'object')     
            {                                                        
                headers = array_keys(parsedJson[0].PaymentRequest);  
        ...
        {                                                             
            ...
            {                                                         
                tbCon += tdRow.format(parsedJson[i].PaymentRequest);  
        ...
        {                                                               
            ...
            {                                                           
                ...
                { 
                    ...
                    { 
                        var value = parsedJson[i].PaymentRequest[headers[j]]; 
