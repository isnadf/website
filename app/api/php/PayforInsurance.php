 ...
 <html>
     ...
     <?php
         ...
         $data = "".
          ...
          "CardHolderName=".$_POST["CardHolderName"]."&".                                           //Language_CardHolderName
          "CardMask=".$_POST["CardMask"]."&".                                                       //Language_CardMask
          "TcknOrVkn=".$_POST["TcknOrVkn"]."&".                                                     //Language_TcknOrVkn
